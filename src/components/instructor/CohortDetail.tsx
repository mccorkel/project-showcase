      ...
      <Flex direction="column" gap="1.5rem">
        ...
        >
            ...
            <Flex direction="column" gap="1.5rem" marginTop="1rem">
              ...
              {filteredStudents.length === 0 ? (
                <Card variation="outlined" padding="1rem">
                  <Text textAlign="center">No students found matching your criteria.</Text>
                </Card>
              ) : (
                <Table>
                  <TableHead>
          ...
          <TabItem title="Analytics">
            <Flex direction="column" gap="1.5rem" marginTop="1rem">
              <Card>
                <Heading level={4}>Cohort Analytics</Heading>
                <Text>
                  Detailed analytics for this cohort are available on the analytics page.
                </Text>
                <Link href={`/secure/instructor/analytics?cohortId=${cohortId}`} legacyBehavior>
                  <Button marginTop="1rem">View Analytics</Button>
                </Link>
              </Card>
            </Flex>
          </TabItem>
