...
const CohortManagement: React.FC<CohortManagementProps> = () => {
  ...
  const handleViewCohort = (cohort: any) => {
    router.push(`/secure/admin/cohorts/${cohort.id}`);
  };
  ...
  return (
    <Card>
      <Flex direction="column" gap="1.5rem">
        ...
        <Text>
          Manage all cohorts, assign instructors, and monitor program performance across the platform.
        </Text>
            ...
            <Table highlightOnHover={true}>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell as="th">Instructors</TableCell>
              ...
              <TableBody>
                {paginatedCohorts.map((cohort) => (
                  <TableRow key={cohort.id}>
                    ...
                    <TableCell>{cohort.instructorCount}</TableCell>
            ...
            {formMode === 'edit' && (
              <Flex direction={{ base: 'column', medium: 'row' }} gap="1rem">
                ...
                <TextField
                  ...
                  type="number"
                  value={selectedCohort.instructorCount.toString()}
                  onChange={(e) => handleInputChange('instructorCount', parseInt(e.target.value, 10) || 0)}
                  min="0"
                  flex="1"
                />
              </Flex>
